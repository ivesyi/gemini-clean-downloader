...
(function() {
  const DICTS = {
    en: {
      ...
      btn_clean_now: 'Remove Watermark',
      btn_clean_now_title: 'Run local watermark removal now',
      ...
      status_request_clean: 'Requesting watermark removal...',
      status_clean_progress: 'Removing watermark: $DONE$/$TOTAL$, failed $FAILED$',
      status_clean_result: 'Watermark removed: $SUCCESS$ ok, $FAILED$ failed',
      status_upload_progress: 'Uploading: $DONE$/$TOTAL$, failed $FAILED$',
      status_upload_result: 'Upload finished: $SUCCESS$ ok, $FAILED$ failed',
      status_clean_upload_result: 'Watermark removed: $SUCCESS$ ok, $FAILED$ failed. Uploaded: $UPLOAD_SUCCESS$ ok, $UPLOAD_FAILED$ failed',
      status_clean_failed: 'Watermark removal failed: $ERROR$',
      ...
      settings_title: 'Gemini Watermark Removal Downloader',
      settings_subtitle: 'Configure the local Docker watermark removal service.',
      ...
      label_delete_cleaned: 'Delete watermark-removed files after upload',
      placeholder_upload_api_url: 'https://cfbed.sanyue.de/upload?authCode=xxxx',
      label_delete_originals: 'Delete originals after watermark removal',
      label_auto_clean: 'Auto remove watermark after downloads finish',
      label_language: 'UI language',
      btn_upload_test: 'Test Upload',
      ...
      status_upload_test_missing: 'Please enter ImgBed upload API URL.',
      status_upload_test_running: 'Uploading test image...',
      status_upload_test_ok: 'Upload ok: $URL$',
      status_upload_test_fail: 'Upload failed: $ERROR$',
    ...
    zh_CN: {
      ...
      status_request_clean: '正在请求去水印...',
      status_clean_progress: '去水印：$DONE$/$TOTAL$，失败 $FAILED$',
      status_clean_result: '去水印完成：成功 $SUCCESS$ 张，失败 $FAILED$ 张',
      status_upload_progress: '上传：$DONE$/$TOTAL$，失败 $FAILED$',
      status_upload_result: '上传完成：成功 $SUCCESS$ 张，失败 $FAILED$ 张',
      status_clean_upload_result: '去水印完成：成功 $SUCCESS$ 张，失败 $FAILED$ 张。上传成功 $UPLOAD_SUCCESS$ 张，失败 $UPLOAD_FAILED$ 张',
      status_clean_failed: '去水印失败：$ERROR$',
      status_watermark_progress: '去水印：$DONE$/$TOTAL$，失败 $FAILED$。上传：$UPLOAD_DONE$/$UPLOAD_TOTAL$，失败 $UPLOAD_FAILED$',
      status_watermark_progress_no_upload: '去水印：$DONE$/$TOTAL$，失败 $FAILED$',
      settings_title: 'Gemini 去水印下载器',
      settings_subtitle: '配置本地 Docker 去水印服务',
      ...
      label_delete_cleaned: '上传后删除去水印文件',
      placeholder_upload_api_url: 'https://cfbed.sanyue.de/upload?authCode=xxxx',
      label_delete_originals: '去水印后删除原图',
      label_auto_clean: '下载完成后自动去水印',
      label_language: '界面语言',
      btn_upload_test: '测试上传',
      btn_save: '保存设置',
      btn_test: '测试连接',
      status_saved: '已保存',
      ...
      status_upload_test_missing: '请填写 ImgBed 上传 API 地址。',
      status_upload_test_running: '正在上传测试图...',
      status_upload_test_ok: '上传成功：$URL$',
      status_upload_test_fail: '上传失败：$ERROR$',
