...
(function() {
  const DICTS = {
    en: {
      ...
      label_upload_api_url: 'ImgBed Upload API URL (e.g. https://cfbed.sanyue.de/upload?authCode=xxxx)',
    ...
    zh_CN: {
      ...
      label_upload_api_url: 'ImgBed 上传 API 地址（例如 https://cfbed.sanyue.de/upload?authCode=xxxx）',
