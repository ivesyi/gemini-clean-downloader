...
(function() {
  const DICTS = {
    en: {
      ...
      label_download_root: 'Chrome default download directory',
      label_input_preview: 'Input path preview',
      label_output_preview: 'Output path preview',
    ...
    zh_CN: {
      ...
      label_download_root: 'Chrome 默认下载目录',
      label_input_preview: '输入路径预览',
      label_output_preview: '结果路径预览',
